...
func (p *kMessageServiceClient) MessageChat(ctx context.Context, req *relation.MessageChatRequest, callOptions ...callopt.Option) (r *relation.MessageChatResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.MessageChat(ctx, req)
}

func (p *kMessageServiceClient) MessageAction(ctx context.Context, req *relation.MessageActionRequest, callOptions ...callopt.Option) (r *relation.MessageActionResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
